...
class Model
{
    ...
    public function getAllWithOrder($referenceColumns = array(), $selectableColumns = array("*"), $allRecords = true, $order = "")
    {   
        return $this->db->retrieve($this->table, (array) $referenceColumns, (array) $selectableColumns, (bool) $allRecords, $order);
    }

    public function getByLimit($referenceColumns, $order = "", $limit, $offset)
    {
        return $this->db->fetchByLimit($this->table, $referenceColumns, $order, $limit, $offset);
    }
